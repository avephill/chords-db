# Parse ICDb _raw_v1..v4.html (Mountain Minor / G Modal tuning) -> chord *.js, index.js, readable txt
...
"@
    ...
    $txtName = if ($k.dir -eq "Ab") { "Abchords-readable-gModalSawmillBanjo.txt" } else { "$($k.dir)chords-readable-gModalSawmillBanjo.txt" }
