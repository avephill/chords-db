# Parse ICDb _raw_v1..v4.html (5-string banjo Standard C / Drop C) -> chord *.js, index.js, readable txt
# StaticCharts PNG alt=… parser only. For pages that use SingleFingering_v2 sprite grids, use
#   generate-banjo-standard-c-drop-c-icdb-composite.ps1
...
"@
    ...
    $txtName = if ($k.dir -eq "Ab") { "Abchords-readable-standardCDropCBanjo.txt" } else { "$($k.dir)chords-readable-standardCDropCBanjo.txt" }
