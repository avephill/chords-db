# Parse ICDb _raw_v1..v4.html (Double C tuning) -> chord *.js, index.js, readable txt
...
"@
    ...
    $txtName = if ($k.dir -eq "Ab") { "Abchords-readable-doubleCBanjo.txt" } else { "$($k.dir)chords-readable-doubleCBanjo.txt" }
