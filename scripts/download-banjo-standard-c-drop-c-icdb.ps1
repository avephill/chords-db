...
#   powershell -File scripts/generate-banjo-standard-c-drop-c-icdb-composite.ps1
# Run from repo root: powershell -File scripts/download-banjo-standard-c-drop-c-icdb.ps1

$ErrorActionPreference = "Stop"
$Root = Split-Path $PSScriptRoot -Parent
$ChordsRoot = Join-Path $Root "src\db\banjo-standard-c-drop-c\chords"

$ct = "1,2,3,5,43,15,16,6,7,4,8,9,10,11,19,20,21,22,23,27,28,12,13,14,17,18,24,25,26,32,29,30,33,34,40,31,35,36,37,38,39,41"
$base = "https://internetchorddatabase.com/ChordCharts/5-String_Banjo_Standard_C__Drop_C_Tuning/?ft=0&dcn=0&pn={0}&ct=$ct&cl=eng&ccs=M&co=p&dcni=1&v="
