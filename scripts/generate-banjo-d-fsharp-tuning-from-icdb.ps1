# Parse ICDb _raw_v1..v4.html (5-string banjo D/F# tuning) -> chord *.js, index.js, readable txt
...
"@
    ...
    $txtName = if ($k.dir -eq "Ab") { "Abchords-readable-dFsharpBanjo.txt" } else { "$($k.dir)chords-readable-dFsharpBanjo.txt" }
