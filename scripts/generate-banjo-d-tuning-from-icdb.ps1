# Parse ICDb _raw_v1..v4.html (5-string banjo D tuning) -> chord *.js, index.js, readable txt
...
"@
    ...
    $txtName = if ($k.dir -eq "Ab") { "Abchords-readable-dTuningBanjo.txt" } else { "$($k.dir)chords-readable-dTuningBanjo.txt" }
