...
$ChordsRoot = Join-Path $Root "src\db\banjo-gmodal-mountain-minor-sawmill\chords"

# Full chord-type list (matches banjo-open-g / double-c ICDb requests) so advanced types are included.
$base = "https://internetchorddatabase.com/ChordCharts/5-String_Banjo_Mountain_Minor__G_Modal_Tuning/?ft=0&dcn=0&pn={0}&ct=1,2,3,5,15,16,6,7,4,8,9,10,11,19,20,21,22,23,27,28,12,13,14,17,18,24,25,26,32,29,30,33,34,40,31,35,36,37,38,39,41&cl=eng&ccs=M&co=p&dcni=1&v="
