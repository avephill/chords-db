# Parse ICDb _raw_v1..v4.html (5-string banjo Open C) -> chord *.js, index.js, readable txt
...
"@
    ...
    $txtName = if ($k.dir -eq "Ab") { "Abchords-readable-openCBanjo.txt" } else { "$($k.dir)chords-readable-openCBanjo.txt" }
